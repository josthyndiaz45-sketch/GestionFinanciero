...
const styles = StyleSheet.create({
  ...
  balance: { fontSize: 36, fontWeight: 'bold', color: '#FFF', marginTop: 8 },
  initialLabel: { fontSize: 12, color: 'rgba(255,255,255,0.7)', marginTop: 4 },
  cardsRow: { flexDirection: 'row', gap: 12, marginBottom: 16 },
  card: { flex: 1, padding: 16, borderRadius: 16, borderWidth: 1 },
  cardIcon: { width: 32, height: 32, borderRadius: 10, backgroundColor: 'rgba(0,0,0,0.05)', justifyContent: 'center', alignItems: 'center' },
  cardLabel: { fontSize: 13, marginTop: 8, fontWeight: '500' },
  cardAmount: { fontSize: 18, fontWeight: 'bold', marginTop: 4 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
  sectionTitle: { fontSize: 18, fontWeight: 'bold' },
  alertCard: { padding: 14, borderRadius: 14, borderWidth: 1, marginBottom: 8 },
  ...
  viewAllBtn: { borderWidth: 1, borderRadius: 12, paddingVertical: 12, alignItems: 'center', marginTop: 8 },
  viewAllText: { fontWeight: '600', fontSize: 14 },
  fab: { position: 'absolute', bottom: 24, right: 24, width: 56, height: 56, borderRadius: 28, justifyContent: 'center', alignItems: 'center', elevation: 6, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 4 },
});
